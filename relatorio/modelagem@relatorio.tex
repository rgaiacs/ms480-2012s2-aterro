...
quadrados $w$ e $z$ é definida no Apêndice~\ref{sse:distance}.} e $l(w, z)$ a
distância entre a reta formada pelos quadrados $w$ e $z$ ao ponto $c$\footnote{A
distância entre a reta formada pelos quadrados $w$ e $z$ ao ponto $c$ é abordada
no Apêndice~\ref{sse:point2line}.}.
