...
É poss\'{i}vel observar que alguns elementos da malha quadriculada encontram-se
apenas parcialmente dentro de uma das regi\~{o}es. Para corrigir isso,
aproximamos as regi\~{o}es para a malha utilizada de modo que todos os
elementos da malha que encontram-se parcialmente presentes em uma das regiões
passa a pertencer totalmente a ela. O resultado \'{e} apresentado na
